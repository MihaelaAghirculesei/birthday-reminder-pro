...
export const MOCK_BIRTHDAY_RAW_DATA: MockBirthdayData[] = [
  { name: 'Uwe Müller', date: '1990-03-15', category: 'family', photo: 'https://i.pravatar.cc/200?img=1', notes: 'Ama i romanzi fantasy, appassionato di caffè, colleziona dischi in vinile', email: 'uwe.mueller@example.com', phone: '+49 170 1234567' },
  { name: 'Bob Smith', date: '1985-06-22', category: 'friends', photo: 'https://i.pravatar.cc/200?img=12', notes: 'Appassionato di fotografia, usa attrezzatura Canon, colore preferito il blu', email: 'bob.smith@example.com' },
  { name: 'Carlo Bruns', date: '1992-09-10', category: 'colleagues', photo: 'https://i.pravatar.cc/200?img=13', notes: 'Fanatico della palestra, ama gli integratori proteici, fan dei film Marvel' },
  { name: 'Diana Werner', date: '1988-12-05', category: 'friends', photo: 'https://i.pravatar.cc/200?img=5', notes: 'Suona la chitarra, appassionata di rock, segue la Formula 1', telegramUsername: 'diana_w' },
  { name: 'Eduard Neumann', date: '1995-02-28', category: 'family', photo: 'https://i.pravatar.cc/200?img=14', notes: 'Amante del giardinaggio, preferisce le piante grasse, allergico ai gatti' },
  { name: 'Fiona Bauer', date: '1987-07-18', category: 'romantic', photo: 'https://i.pravatar.cc/200?img=9', notes: 'Istruttrice di yoga, ama il tè biologico, usa app di meditazione, dieta senza glutine', email: 'fiona.bauer@example.com', phone: '+44 7700 900123', telegramUsername: 'fiona_yoga' },
  { name: 'Georg Maier', date: '1993-10-03', category: 'colleagues', photo: 'https://i.pravatar.cc/200?img=15', notes: 'Costruisce PC da gaming, gioca a FPS, preferito: Call of Duty' },
  { name: 'Hanna Mayer', date: '1991-04-12', category: 'friends', photo: 'https://i.pravatar.cc/200?img=10', notes: 'Vegetariana, ama la cucina italiana, apprezza il vino bianco', phone: '+1 555 0199' },
  { name: 'Isabella Garcia', date: '1994-01-08', category: 'family', photo: 'https://i.pravatar.cc/200?img=16', notes: 'Appassionata di moda, taglia S, preferisce lo stile minimalista', email: 'isabella.garcia@example.com' },
  { name: 'Jack Thompson', date: '1989-05-19', category: 'acquaintances', photo: 'https://i.pravatar.cc/200?img=17', notes: 'Appassionato di tecnologia, usa iPhone 15, vuole gli AirPods Pro', email: 'jack.t@example.com', telegramUsername: 'jacktech' },
  ...
  { name: 'Maya Patel', date: '1993-02-28', category: 'family', photo: 'https://i.pravatar.cc/200?img=21', notes: 'Si è trasferita a New York, studia spagnolo, ama il trekking', email: 'maya.patel@example.com' },
  ...
  { name: 'Rachel Berg', date: '1990-09-04', category: 'friends', photo: 'https://i.pravatar.cc/200?img=24', notes: 'Travel blogger, ha visitato 40 paesi, vuole andare in Giappone' },
  ...
  { name: 'Ulrich Braun', date: '1987-01-17', category: 'other', photo: null, notes: 'Insegnante di storia, appassionato della Guerra Civile, legge biografie' },
  ...
  { name: 'Jessica Baumann', date: '1989-07-30', category: 'friends', photo: 'https://i.pravatar.cc/200?img=40', notes: 'Giornalista, scrive per The Times, ama i reportage investigativi' },
  ...
  { name: 'Marcus "GhostByte" Johnson', date: '1995-06-14', category: 'gaming', photo: 'https://i.pravatar.cc/200?img=52', notes: 'Streamer su Twitch, gioca a Fortnite, usa periferiche Razer' },
